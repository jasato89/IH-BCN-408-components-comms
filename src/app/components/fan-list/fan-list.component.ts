...
export class FanListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.madridFans.push(new Fan("John Doe", 30, "United States", ""));
    this.madridFans.push(new Fan("Manuel García", 30, "Spain", ""));
    this.madridFans.push(new Fan("Lucia Martin ", 25, "Spain", ""));

    this.barcelonaFans.push(new Fan("Maite Cardozo", 33, "Venezuela", ""));
    this.barcelonaFans.push(new Fan("Cesar Bianco", 31, "Italy", ""));
    this.barcelonaFans.push(new Fan("Akira Yamaoka", 38, "Japan", ""));
